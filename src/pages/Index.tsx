    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <motion.div
              ...
              className="mt-2 h-1 w-64 origin-left rounded-full bg-primary/40"
            />
            <motion.p
            ...
            <motion.div
              ...
              className="mt-8 flex items-center gap-4 rounded-xl border border-border bg-secondary/60 p-4"
            >
          ...
          >
            ...
            <div className="w-[320px] rounded-3xl border border-border bg-card p-5 shadow-xl">
              ...
              <motion.div
                ...
                className="mb-3 ml-0 mr-auto max-w-[80%] rounded-2xl rounded-tl-sm bg-primary px-4 py-3 text-sm text-primary-foreground"
                style={{ fontFamily: "'Inter', sans-serif" }}
              >
              ...
              <motion.div
                ...
                className="mb-3 ml-auto mr-0 max-w-[80%] rounded-2xl rounded-tr-sm bg-secondary px-4 py-3 text-sm text-foreground"
                style={{ fontFamily: "'Inter', sans-serif" }}
              >
            ...
            <motion.div
              ...
              className="absolute -right-2 top-8 flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2 shadow-md"
            >
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mx-auto max-w-3xl rounded-2xl bg-foreground px-8 py-16 text-center"
        >
